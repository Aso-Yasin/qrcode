...
class QrScannerScreen extends StatefulWidget {
  final String data; // Add this line to accept the data
...
class _QrScannerScreenState extends State<QrScannerScreen> {
  ...
  Future<void> _processScannedData(String? data) async {
    ...
    // Save scanned QR code data to history
    await DatabaseHelper().insertQRCode("scanned", data);

    // Display scanned data in the modal bottom sheet
  ...
  Widget build(BuildContext context) {
    ...
    if(!hasPermission) {
      ...
      scannerController.toggleTorch();
        ...
        body: Stack(
          children: [
            // i am using emulator that's why camera is showing like this.
            MobileScanner(
