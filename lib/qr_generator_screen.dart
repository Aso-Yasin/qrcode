...
END:VCARD''';
    ...
    print('Generated QR Data: $data'); // Debug print

    // Attempt to insert only if data is non-empty or type is text
    if (data.isNotEmpty || selectedType == 'text') {
      try {
        DatabaseHelper().insertQRCode(selectedType, data);
        print('Data inserted into database: Type: $selectedType, Data: $data');
      } catch (e) {
